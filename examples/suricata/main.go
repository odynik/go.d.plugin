...
var version = "v0.0.1-suricata"

type suricata struct{ module.Base }

func (suricata) Cleanup() {}

func (suricata) Init() bool { return true }

func (suricata) Check() bool { return true }

func (suricata) Charts() *module.Charts {
...
func main() {
	...
	module.Register("suricata", module.Creator{
		Create: func() module.Module { return &suricata{} }},
	)
